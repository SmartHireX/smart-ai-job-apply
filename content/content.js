...
function addAccordionStyles() {
    ...
    style.textContent = `
        ...
        #smarthirex-accordion-sidebar .field-actions {
            display: flex;
            align-items: center;
            gap: 8px;
        }
        
        #smarthirex-accordion-sidebar .regenerate-btn {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 28px;
        ...
        #smarthirex-accordion-sidebar .regenerate-btn:hover {
            transform: scale(1.1) rotate(180deg);
            box-shadow: 0 4px 12px rgba(139, 92, 246, 0.4);
            background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%);
        }
        
        #smarthirex-accordion-sidebar .regenerate-btn:active {
            transform: scale(0.95);
        }
        
        #smarthirex-accordion-sidebar .regenerate-btn svg {
            color: white;
        }
