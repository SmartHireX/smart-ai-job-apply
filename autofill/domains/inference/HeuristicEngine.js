...
class HeuristicEngine {
     ...
     * EXPANDED: Now includes 200+ aliases for improved accuracy (+1-2%)
     *
     * v3.1.0: Added comprehensive coverage for:
     * - Social media (LinkedIn, GitHub, Twitter, Portfolio)
     * - International names (Spanish, French)
    ...
    static FIELD_ALIASES = {
        ...
        'home_phone': 'phone',
        'work_phone': 'phone',
        'telefono': 'phone', // Spanish
        'telephone_portable': 'phone', // French
    ...
    static PATTERNS = {
        ...
        job_title: {
            ...
            confidence: 0.96,
            category: 'work',
            // ENHANCED v3.1.0: Stronger negative patterns to avoid false positives
            negative: /\b(job[_\-\s]?description|page[_\-\s]?title|document[_\-\s]?title|book[_\-\s]?title|fit[_\-\s]?for[_\-\s]?(this|the)?[_\-\s]?role|consent|privacy|applying|processed|apply[_\-\s]?for|posting[_\-\s]?title|position[_\-\s]?available|opening[_\-\s]?for|\bat\b.*company|^(job|position)$)\b/i
        },
        ...
        company_name: {
            ...
            confidence: 0.95,
            category: 'work',
            // ENHANCED v3.1.0: Avoid false positives from page headers/descriptions
            negative: /\b(company[_\-\s]?(size|type|culture|website|industry|information|description|overview)|agreement|employer\(s\)|prevent|restrictive|about[_\-\s]?(the[_\-\s]?)?company|our[_\-\s]?company|company[_\-\s]?profile)\b/i
        },
